...
Edited by Niek Rutten for webcam integration
"""
...
from webcam_loader import  webcam_data
...
def Prepare_Webcam_DataLoaders(Network_parameters, split,input_size=224): #function to load webcam data
    ...
    train_dataset = webcam_data(img_transform=data_transforms['train'])
    test_dataset = webcam_data(img_transform=data_transforms['train'])
    validation_dataset = webcam_data(img_transform=data_transforms['train'])
